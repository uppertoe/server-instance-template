...
**Instance note — rch-vps (2026-07-05):** control evidence for every row lives
in `../reports/*-rch-vps-2026-07-04/` (INDEX.md is control-tagged) and the
public CI regression page. Definitive host result: CIS L2 432 pass · 0 fail ·
all non-passes register-documented (`../scaffold/docs/08-security-model.md`).
