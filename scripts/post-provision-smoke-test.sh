...
check_remote "SSH banner file is present" "[[ -f /etc/ssh/banner.txt ]]"
...
check_remote "sudo logging is configured" "sudo grep -F 'Defaults logfile=\"/var/log/sudo.log\"' /etc/sudoers.d/01-vps-scaffold-logging >/dev/null"
